...
package body ada_main is
   ...
   E524 : Short_Integer; pragma Import (Ada, E524, "aws__services__dispatchers__uri_E");
   E527 : Short_Integer; pragma Import (Ada, E527, "default__dispatchers_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "default__dispatchers__finalize_spec");
      begin
         F1;
      end;
      declare
         procedure F2;
         pragma Import (Ada, F2, "aws__services__dispatchers__uri__finalize_body");
      begin
         E524 := E524 - 1;
         F2;
      end;
      declare
         procedure F3;
         pragma Import (Ada, F3, "aws__services__dispatchers__uri__finalize_spec");
      begin
         F3;
      end;
      E437 := E437 - 1;
      ...
      declare
         procedure F54;
         pragma Import (Ada, F54, "templates_parser_tasking__finalize_body");
      begin
         E356 := E356 - 1;
         F54;
      end;
      ...
      declare
         procedure F55;
         pragma Import (Ada, F55, "aws__containers__tables__finalize_spec");
      begin
         F55;
      end;
      E242 := E242 - 1;
      ...
      declare
         procedure F59;
         pragma Import (Ada, F59, "gnat__sockets__finalize_body");
      begin
         E368 := E368 - 1;
         F59;
      end;
      declare
         procedure F60;
         pragma Import (Ada, F60, "gnat__sockets__finalize_spec");
      begin
         F60;
      end;
      E318 := E318 - 1;
   ...
   begin
      ...
      E524 := E524 + 1;
      Default.Dispatchers'Elab_Spec;
      Default.Dispatchers'Elab_Body;
      E527 := E527 + 1;
   end adainit;
...
--  BEGIN Object file/option list
   --   C:\Users\pmartinezg\OneDrive - Indra\Documentos\TalentCamp\ADA\14_AplicacionesWeb\obj\default.o
   --   C:\Users\pmartinezg\OneDrive - Indra\Documentos\TalentCamp\ADA\14_AplicacionesWeb\obj\default-dispatchers.o
   --   C:\Users\pmartinezg\OneDrive - Indra\Documentos\TalentCamp\ADA\14_AplicacionesWeb\obj\default-main.o
   --   -LC:\Users\pmartinezg\OneDrive - Indra\Documentos\TalentCamp\ADA\14_AplicacionesWeb\obj\
   --   -LC:\Users\pmartinezg\OneDrive - Indra\Documentos\TalentCamp\ADA\14_AplicacionesWeb\obj\
